...
class PlanComPage extends GetWidget<AuthController> {
  String rad = "5000";
  double minRat = 0;
  double maxRat = 5;
  double minPri = 0;
  ...
  Future cargaDatos() async {
    ...
    if(nombres.length > numA){
      ...
      } while (nombres.length > numA);
    }
    numList = nombres.length;
                  ...
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Obx(
                          () => Visibility(
                            visible: _visibleButton.value,
                            child: ElevatedButton(
                              onPressed: () => {_launchURL()},
                              style: ElevatedButton.styleFrom(
                                shape: const StadiumBorder(),
                                primary: Color(controller.purpura),
